...
export function CreateModal({ closeModal }: ModalProps){
  ...
  const handleEditSubmit = () => {
    // Lógica de edição com o ID aqui
  }
          ...
          <div className={styles.button_container}>
            {!editMode ? (
              <>
                ...
                <button onClick={handleEdit} className={`${styles.btn_secondary} ${styles.btn_edit}`}>
                  Editar
                </button>
              </>
            ) : (
              <>
                <button onClick={handleGoBack} className={`${styles.btn_secondary} ${styles.btn_submit}`}>
                Voltar
                </button>
                <button onClick={handleDelete} className={`${styles.btn_secondary} ${styles.btn_delete}`}>
                  Deletar
                </button>
              </>
            )}
